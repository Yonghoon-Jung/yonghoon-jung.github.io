...
{% highlight html %}
<br>func add(jyh: Int, yhj: Int) -> Int {
<br>    return(jyh+yhj)
<br>}
<br>print(add(jyh:100, yhj:200))

<br>func add(first jyh: Int, second yhj: Int) -> Int {
<br>    return(jyh+yhj)
<br>}
<br>print(add(first:100, second200))

<br>func add(_ jyh: Int, _ yhj: Int) -> Int { // 이 방법은 잘 안씁니다.
<br>    return(jyh+yhj)
<br>}
<br>print(add(100, 200))

<br>func add(_ jyh: Int, with yhj: Int) -> Int {
<br>    return(jyh+yhj)
<br>}
<br>print(add(100, with:200))

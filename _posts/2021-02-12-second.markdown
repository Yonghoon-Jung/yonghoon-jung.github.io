...
## Summary:
매개 변수의 개념과 가감승제, 함수, inout을 알기 쉽게 설명합니다.<br>
Explain the concepts of parameters, additive, function, and in-out in an easy-to-understand way.

#### Table of Contents
- [Parameters](#parameters)
FourFundamentalRulesOfArithmetics
- [FourFundamentaRulesOfArithmetics](#fourfundamentalrulesofarithmetics)
- [Star](#star)
...
{% highlight html %}
func add(jyh: Int, yhj: Int) -> Int {
    return(jyh+yhj)
}
print(add(jyh:100, yhj:200))

func add(first jyh: Int, second yhj: Int) -> Int {
    return(jyh+yhj)
}
print(add(first:100, second200))

func add(_ jyh: Int, _ yhj: Int) -> Int { // 이 방법은 잘 안씁니다.
    return(jyh+yhj)
}
print(add(100, 200))

func add(_ jyh: Int, with yhj: Int) -> Int {
    return(jyh+yhj)
}
...
func sss(a: Int, b: Int) -> (sum: Int,sub: Int, mul: Int, div: String, rem: Int) {
    ...
    let sub = a-b
    let mul = a\*b
    let div = String(format: "%.6", Double(a)/Doubleb))
    let rem = a%b
